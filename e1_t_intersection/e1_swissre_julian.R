...
cohen.d(capab ~ cond_name, data = d_merged, paired = FALSE)
...
cohen.d(superh ~ cond_name, data = d_merged, paired = FALSE)
...
write.csv(d_merged, 'e1_processed.csv')
